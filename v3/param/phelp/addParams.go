...
func (h *StdHelp) addParamHandlingParams(ps *param.PSet) {
	...
	ps.AddGroup(groupName,
		"These are the parameter-handling parameters.\n\n"+
			...
			" have been set and the handling of parameter errors.")
	...
	ps.Add("params-show-sources",
		...
		"after all the parameters are set a message will be printed"+
			" showing all the places (other than the command line)"+
			" that a parameter can be set. This will list any"+
	...
	ps.Add("params-show-unused",
		...
		"after all the parameters are set a message will be printed"+
			...
			"Parameters set in any configuration files or through"+
			...
			" treated as an error. Setting this parameter will allow you"+
			" to check for spelling mistakes or other typos.\n\n"+
			"The program will exit if this parameter is set",
		param.Attrs(param.CommandLineOnly|param.DontShowInStdUsage),
		param.GroupName(groupName))
	...
	ps.Add("params-dont-exit-on-errors",
		...
		"if errors are detected when processing the parameters the"+
			" program will exit unless this flag is set to true",
		param.Attrs(param.CommandLineOnly|param.DontShowInStdUsage),
		param.GroupName(groupName))
	...
	ps.Add("params-exit-after-parsing",
		...
		"exit after the parameters have been parsed. This can allow"+
			" you to just check the parameters or investigate what"+
			" would have been set and not actually run the program.\n\n"+
...
func (h *StdHelp) addUsageParams(ps *param.PSet) {
	...
	ps.AddGroup(groupName,
		"These are the usage parameters."+
			" They can be used to show a usage message"+
			" in various levels of detail.")

	ps.Add(usageArgName, helpType{h: h},
		"print a message giving the valid parameters and exit.\n\n"+
			"By default any parameters which the application deems"+
			" less commonly useful or advanced will not be shown."+
			" To see all the parameters use the "+usageFullArgName+
			" parameter.\n\n"+
			"For a more concise usage message use the "+usageSummaryArgName+
			" parameter",
	...
	ps.Add(usageFullArgName, helpFull{h: h},
		"print the usage message giving all the valid parameters and exit."+
	...
	ps.Add("help-all-short",
		helpType{
			h:     h,
			style: Short,
		},
		"print a summarised usage message giving all the valid parameters."+
			" This is the equivalent of giving both the "+
			usageFullArgName+" and the "+usageSummaryArgName+
			" parameters.\n\n"+
			"The program will exit if this parameter is set.",
		param.Attrs(param.CommandLineOnly|param.DontShowInStdUsage),
	...
	ps.Add(usageSummaryArgName,
		...
		"print a summarised usage message giving the valid parameters."+
			" Whether the suppressed parameters are shown is"+
			" determined by the "+usageFullArgName+" parameter."+
			" To see all the parameters (including suppressed ones) in"+
	...
	ps.Add("help-show-groups",
		...
		"print the parameter groups that have been set up."+
			...
			"This can allow you to see the sets of parameters in a"+
			" concise way and allow you to choose which you want to"+
			" select for closer examination.\n\n"+
			"The program will exit if this parameter is set.",
		param.Attrs(param.CommandLineOnly|param.DontShowInStdUsage),
